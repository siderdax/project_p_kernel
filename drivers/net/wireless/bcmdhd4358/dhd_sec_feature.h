...
#if defined(CONFIG_MACH_MV7420) || defined(CONFIG_ARCH_MSM8994)
#define SUPPORT_MULTIPLE_MODULE_CIS
#endif /* defined(CONFIG_MACH_MV7420) || defined(CONFIG_ARCH_MSM8994) */
...
#if defined(CONFIG_MACH_UNIVERSAL5433) || defined(CONFIG_MACH_MV7420)
#define USE_EXYNOS_PCIE_RC_PMPATCH
#endif /* CONFIG_MACH_UNIVERSAL5433 || CONFIG_MACH_MV7420 */
