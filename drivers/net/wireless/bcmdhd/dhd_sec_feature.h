...
#define READ_MACADDR
	...
	defined(CONFIG_MACH_XYREF5422) || defined(CONFIG_MACH_MV7420) || defined(CONFIG_MACH_UNIVERSAL5430)
#define CUSTOM_SET_CPUCORE
#define PRIMARY_CPUCORE 0
#define MAX_RETRY_SET_CPUCORE 5
#define DPC_CPUCORE 4
#define RXF_CPUCORE 5
#endif /* CONFIG_MACH_HL3G || CONFIG_MACH_HLLTE || CONFIG_MACH_XYREF5422 || CONFIG_MACH_MV7420 */
