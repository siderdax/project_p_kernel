...
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_DSX
#define TICK_15MS (unsigned int)500//15ms // 333.33   //10ms/TICK_RESOLUTION
#endif
#ifdef CONFIG_TOUCHSCREEN_MELFAS
#define TICK_15MS (unsigned int)400   //10ms/TICK_RESOLUTION
#endif
