...
int meizu_lcd_type = 1;/*Modified by Huangwenjian 20150331 for compile*/
...
static int fwu_start_reflash(void)
{
	...
	dev_dbg(rmi4_data->pdev->dev.parent,
		...
		__func__, (int)fw_entry->size);/*Modified by Huangwenjian 20150331 for compile*/
		...
		char *buf, loff_t pos, size_t count)
{
	...
	if (count < fwu->config_size) {
		dev_err(rmi4_data->pdev->dev.parent,
				...
				__func__, (int)count);/*Modified by Huangwenjian 20150331 for compile*/
		return -EINVAL;
	}
