...
enum optical_stabilization_mode {
	...
	OPTICAL_STABILIZATION_MODE_CENTERING = 8, /* Centering mo */
};
...
enum aa_capture_intent {
	...
	AA_CAPTURE_INTENT_STILL_CAPTURE_RAW = 100,
};
...
struct camera2_aa_uctl {
	struct camera2_obj_af_ctl af_data;
};
