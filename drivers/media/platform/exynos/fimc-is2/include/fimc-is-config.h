...
#define SOC_SCP
#define SOC_VRA
#define SOC_FLASH_DIRECT_CONTROL
/* Post Processing Configruation */
/* #define ENABLE_DRC */
/* #define ENABLE_DIS */
#define ENABLE_DNR
