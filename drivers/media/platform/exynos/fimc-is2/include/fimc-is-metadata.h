...
struct camera2_scaler_uctl {
    /* Input Image Address */
//    uint32_t sourceAddress[4]; //iankim
	/** \brief
...
enum reserved_drc_mode {
	RESERVED_DRC_OFF = 1,
	RESERVED_DRC_ON,
};

enum reserved_wdr_mode {
	RESERVED_WDR_OFF = 1,
	RESERVED_WDR_ON = 2,
	RESERVED_WDR_AUTO = 3,
	TOTALCOUNT_RESERVED_WDR,
	RESERVED_WDR_UNKNOWN,
};

enum reserved_paf_mode {
	RESERVED_PAF_OFF = 1,
	RESERVED_PAF_ON,
};

enum reserved_bypass_mode {
	RESERVED_FULL_BYPASS_OFF = 1,
	RESERVED_FULL_BYPASS_ON,
};

enum reserved_lsc_mode {
	RESERVED_LSC_OFF = 1,
	RESERVED_LSC_ON,
};

enum reserved_bpc_mode {
	RESERVED_BPC_OFF = 1,
	RESERVED_BPC_ON,
};

struct camera2_reserved_uctl {
	enum reserved_drc_mode drc_mode;
	enum reserved_wdr_mode wdr_mode;
	enum reserved_paf_mode paf_mode;
	enum reserved_lsc_mode lsc_mode; // lsc on/off
	enum reserved_bpc_mode bpc_mode; // bpc on/off
	enum reserved_bypass_mode bypass_mode; // full bypass
};
...
struct camera2_uctl {
	...
	struct camera2_reserved_uctl	reservedUd;
...
struct camera2_udm {
	...
	struct camera2_reserved_udm	reservedUdm;
