...
static void vibrator_power(int onoff)
{
	...
	regulator = regulator_get(NULL, "vdd_ldo25");
	if(regulator == NULL) {
...
#define gpio_VIBRATOR_PM_OPS (&vibrator_pm_ops)
#else
#define gpio_VIBRATOR_PM_OPS NULL
#endif
...
MODULE_ALIAS("platform:gpio-vib");
